    ...
    return (
        <InspectorControls>
            <PanelBody title={__('Thumbnail')} initialOpen={false}>
                ...
                <CustomSelectControl
                    label={__('Ribbon')}
                    value={attributes?.cardThumbnailRibbon}
                    __nextUnconstrainedWidth
                    options={[
                        { name: __('New'), label: 'New', key: 'tour-card-new-ribbon' },
                        { name: __("Open"), label: 'Open', key: 'tour-card-open-ribbon' },
                        { name: __("Full"), label: 'Full', key: 'tour-card-full-ribbon' },
                        { name: __("Filling Fast"), label: 'Filling Fast', key: 'tour-card-filling-fast-ribbon' },
                    ]}
            ...
            <PanelBody title='Tour Details' initialOpen={false}>
                ...
                />
                <MenuURL
                    label="Tour Page Link"
                    value={attributes?.cardTourPageLink}
                    onChange={(value) => setAttributes({ cardTourPageLink: value })}
                />
            </PanelBody>
            ...
            <PanelBody title='Tour Link' initialOpen={false}>
                <TextControl
